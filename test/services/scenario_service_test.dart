  ...
  group('Scenario Service Tests', () {
    ...
    test('Should generate all scenario types without errors', () {
      for (final scenario in ScenarioType.values) {
        expect(
          () => service.generateScenario(scenario, l10n: mockL10n),
          returnsNormally,
        );
      }
    });
    ...
    test('Each scenario should generate appropriate number of bodies', () {
      ...
      final randomBodies = service.generateScenario(
        ScenarioType.random,
        l10n: mockL10n,
      );
      ...
      final earthMoonSun = service.generateScenario(
      ...
      final binaryStars = service.generateScenario(
      ...
      final asteroidBelt = service.generateScenario(
      ...
      final galaxy = service.generateScenario(
      ...
      final solarSystem = service.generateScenario(
    ...
    test('All bodies should have valid properties', () {
      for (final scenario in ScenarioType.values) {
        final bodies = service.generateScenario(scenario, l10n: mockL10n);
