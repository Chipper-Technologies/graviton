...
class ScenarioEditorMetadataPanel extends StatefulWidget {
  ...
  @override
  State<ScenarioEditorMetadataPanel> createState() => _ScenarioEditorMetadataPanelState();
}

class _ScenarioEditorMetadataPanelState extends State<ScenarioEditorMetadataPanel> {
      ...
      child: Column(
        ...
        children: [
          ...
          _buildTextField(
            ...
            label: 'Description',
            hint: 'Describe what this scenario demonstrates',
            maxLines: 3,
            onChanged: (_) => _updateMetadata(),
          ),
