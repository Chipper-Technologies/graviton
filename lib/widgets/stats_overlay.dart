...
class StatsOverlay extends StatelessWidget {
    ...
    return Positioned(
      ...
      child: Opacity(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(color: AppColors.uiBlackOverlay, borderRadius: BorderRadius.circular(8)),
          child: Column(
            ...
            children: [
              Text(
                ...
                style: Theme.of(
                  context,
                ).textTheme.titleSmall?.copyWith(color: AppColors.uiWhite, fontWeight: FontWeight.bold),
              ),
              const SizedBox(height: 8),
              Text(
                '${l10n.stepsLabel}: ${l10n.stepsCount(appState.simulation.stepCount)}',
                style: const TextStyle(color: AppColors.uiWhite70, fontSize: AppTypography.fontSizeSmall),
              ),
              Text(
              ...
              Text(
                ...
                style: TextStyle(
                  color: appState.simulation.isPaused ? AppColors.uiStatusOrange : AppColors.uiStatusGreen,
              ...
              if (appState.simulation.bodies.any((body) => body.canBeHabitable)) ...[
                Text(
  ...
  String _getLocalizedHabitabilityStatus(AppLocalizations l10n, HabitabilityStatus status) {
    switch (status) {
